...
class gwnet(nn.Module):
    def __init__(self, seq_in, batch_size, device, dropout=0.3, supports=None, gcn_bool=True, addaptadj=True,
        ...
        for b in range(blocks):
            ...
            for i in range(layers):
                ...
                additional_scope *= 2
                if self.gcn_bool:
                    self.gconv.append(gcn(dilation_channels, residual_channels, dropout, support_len=batch_size))
